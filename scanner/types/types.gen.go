...
type AssetScanInput struct {
	...
	Type *AssetScanInputType `json:"type,omitempty"`
}
...
type Scan struct {
	...
	// Status Describes status of a multi-asset scan.
...
// ScanStatus Describes status of a multi-asset scan.
type ScanStatus struct {
	...
	// | State      | Description                                |
	// | ---------- | -------------------------------------------|
	// | Pending    | The initial state when the scan is created |
	// | InProgress | The scanner is scanning provided assets    |
	// | Aborted    | The scan has been aborted                  |
	// | Failed     | Scanner could not scan given assets        |
...
type ScanTemplate struct {
	...
	AssetScanInputs *[]AssetScanInput `json:"assetScanInputs,omitempty"`
