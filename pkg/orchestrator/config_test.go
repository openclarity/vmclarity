	...
	tests := []struct {
	...
	}{
		{
			...
			EnvVars: map[string]string{
				...
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_GITLEAKS_PATH":            "/opt/gitleaks",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_CLAMSCAN_PATH":            "/opt/clamscan",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_FRESHCLAM_PATH":           "/opt/freshclam",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_FRESHCLAM_MIRROR":         "freshclam.mirror.org",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_LYNIS_PATH":               "/opt/lynis",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_CHKROOTKIT_PATH":          "/opt/chrootkit",
				"VMCLARITY_ORCHESTRATOR_ASSETSCAN_WATCHER_SCANNER_YARA_PATH":                "/opt/yara",
			...
			ExpectedConfig: &Config{
				...
				AssetScanWatcherConfig: assetscanwatcher.Config{
					...
					ScannerConfig: assetscanwatcher.ScannerConfig{
						...
						GitleaksBinaryPath:            "/opt/gitleaks",
						ClamBinaryPath:                "/opt/clamscan",
						FreshclamBinaryPath:           "/opt/freshclam",
						AlternativeFreshclamMirrorURL: "freshclam.mirror.org",
						LynisBinaryPath:               "/opt/lynis",
						ChkrootkitBinaryPath:          "/opt/chrootkit",
						YaraBinaryPath:                "/opt/yara",
					},
				},
			...
			ExpectedConfig: &Config{
				...
				AssetScanWatcherConfig: assetscanwatcher.Config{
					...
					ScannerConfig: assetscanwatcher.ScannerConfig{
						...
						ScannerImage:                  "",
						GitleaksBinaryPath:            assetscanwatcher.DefaultGitleaksBinaryPath,
						ClamBinaryPath:                assetscanwatcher.DefaultClamBinaryPath,
						FreshclamBinaryPath:           assetscanwatcher.DefaultFreshclamBinaryPath,
						AlternativeFreshclamMirrorURL: "",
						LynisBinaryPath:               assetscanwatcher.DefaultLynisInstallPath,
						ChkrootkitBinaryPath:          assetscanwatcher.DefaultChkrootkitBinaryPath,
						YaraBinaryPath:                assetscanwatcher.DefaultYaraBinaryPath,
					},
				},
				AssetScanEstimationWatcherConfig: assetscanestimationwatcher.Config{
