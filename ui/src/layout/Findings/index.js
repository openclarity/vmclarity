...
const FINDINGS_TAB_ITEMS = {
    ...
    MISCONFIGURATIONS: {id: "misconfigurations", path: "misconfigurations", title: "Misconfigurations", component: () => "TBD"},
    ...
    ROOTKITS: {id: "rootkits", path: "rootkits", title: "Rootkits", component: () => "TBD"},
