...
import (
	...
	uibackend_types "github.com/openclarity/vmclarity/uibackend/types"
)
		...
		ginkgo.It("should finish successfully", func(ctx ginkgo.SpecContext) {
			...
			gomega.Eventually(func() bool {
				findingsTrends, err := uiClient.GetDashboardFindingsTrends(
					ctx,
					uibackend_types.GetDashboardFindingsTrendsParams{
				...
				for _, trend := range *findingsTrends {
					if *trend.FindingType == uibackend_types.VULNERABILITY {
