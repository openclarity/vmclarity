...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | postgresql | 15.5.14 |
...
| gateway.image.tag | string | `"1.27.0"` | Gateway service container tag |
...
| postgresql.image.tag | string | `"16.3.0-debian-12-r14"` | Postgresql container tag |
