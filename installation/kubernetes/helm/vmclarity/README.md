...
| gateway.image.tag | string | `"1.26.0"` | Gateway service container tag |
...
| postgresql.image.tag | string | `"16.3.0-debian-12-r13"` | Postgresql container tag |
...
| trivyServer.image.tag | string | `"0.52.2"` | Trivy Server container tag |
