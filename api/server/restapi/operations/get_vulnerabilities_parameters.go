...
func (o *GetVulnerabilitiesParams) validateSortKey(formats strfmt.Registry) error {
	...
	if err := validate.EnumCase("sortKey", "query", o.SortKey, []interface{}{"vulnerabilityName", "packageName", "packageVersion", "severity", "instances", "fixVersion", "source"}, true); err != nil {
		return err
	}
