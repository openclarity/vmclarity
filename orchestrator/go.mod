...
require (
	...
	github.com/aquasecurity/trivy v0.50.0 // indirect
...
replace helm.sh/helm/v3 => github.com/zregvart/helm/v3 v3.0.0-20240318093951-dda9052de218
...
replace github.com/testcontainers/testcontainers-go => github.com/testcontainers/testcontainers-go v0.29.1
